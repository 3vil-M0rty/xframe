...
export const translations = {
  ...
  en: {
    ...
    payroll: {
      ...
      table: { period: "Period", employees: "Employees", gross: "Gross", net: "Net" },
      status: { draft: "Draft", completed: "Completed", voided: "Voided" },
      payslipStatus: { draft: "Draft", validated: "Validated", paid: "Paid" },
      actions: { view: "View", complete: "Complete", regenerate: "Regenerate", markPaid: "Mark as paid" },
    ...
    documents: {
      ...
      fields: { employee: "Employee", type: "Type", label: "Label", labelPlaceholder: "e.g. National ID card", expiryDate: "Expiry date", file: "File" },
      types: {
    ...
    attendance: {
      ...
      fields: { employee: "Employee", date: "Date", clockIn: "Clock in", clockOut: "Clock out" },
    ...
    reports: {
      ...
      stats: { totalHeadcount: "Total headcount", activeEmployees: "Active employees" },
      charts: {
    ...
    auditLog: {
      ...
      errors: { fetchFailed: "Failed to load the audit log" },
    },
  ...
  fr: {
    ...
    payroll: {
      ...
      table: { period: "Période", employees: "Employés", gross: "Brut", net: "Net" },
      status: { draft: "Brouillon", completed: "Clôturé", voided: "Annulé" },
      payslipStatus: { draft: "Brouillon", validated: "Validé", paid: "Payé" },
      actions: { view: "Voir", complete: "Clôturer", regenerate: "Régénérer", markPaid: "Marquer comme payé" },
    ...
    documents: {
      ...
      fields: { employee: "Employé", type: "Type", label: "Libellé", labelPlaceholder: "ex. Carte d'identité nationale", expiryDate: "Date d'expiration", file: "Fichier" },
      types: {
    ...
    attendance: {
      ...
      fields: { employee: "Employé", date: "Date", clockIn: "Entrée", clockOut: "Sortie" },
    ...
    reports: {
      ...
      stats: { totalHeadcount: "Effectif total", activeEmployees: "Employés actifs" },
      charts: {
    ...
    auditLog: {
      ...
      errors: { fetchFailed: "Échec du chargement du journal d'audit" },
    },
