...
// Multilingual (fr/en/ar) content layer for `description` and
// `businessActivity` — see plugins/translatable.js. Deliberately
// NOT applied to `name`/`tradeName`/`shortName`: those are the
// company's legal identity, not descriptive UGC — they shouldn't
// be machine-translated.
companySchema.plugin(translatable, { fields: ["description", "businessActivity"] });
