              ...
              <div key={dept._id} className={styles.deptCard}>
                ...
                {isExpanded && (
                  <div className={styles.deptBody}>
                    {dept.description && <p className={styles.deptDescription}>{dept.description}</p>}
                    ...
                    {positions.length === 0 ? (
                      ...
                      <div className="dataTable">
                        <div className="dataTableHead" style={{ gridTemplateColumns: "1.3fr 1fr 1fr 1.2fr 80px" }}>
                        ...
                        {positions.map((position) => (
                          <div key={position._id} className="dataTableRow" style={{ gridTemplateColumns: "1.3fr 1fr 1fr 1.2fr 80px" }}>
