...
// ======================================================
// GET ALL CONTRACTS
// GET /api/contracts?companyId=&employeeId=&search=&status=&page=&limit=
// ======================================================

router.get("/", async (req, res) => {
  try {
    const { companyId, employeeId, search, status, page = 1, limit = 20 } = req.query;
