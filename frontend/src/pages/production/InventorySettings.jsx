...
import { Settings, Plus, Edit, Trash2, BriefcaseBusiness } from "lucide-react";
            ...
            return (
              <div key={category._id} className={styles.categoryCard}>
                ...
                <div className={styles.categoryInfo}>
                  ...
                  {category.description && <span className={styles.categoryDescription}>{category.description}</span>}
                </div>
