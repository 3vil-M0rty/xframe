...
export default function Advances() {
  ...
  useEffect(() => {
    setPage(1);
  }, [selectedCompanyId, statusFilter, debouncedSearch]);
  ...
  const [translatingAdvance, setTranslatingAdvance] = useState(null);
  const handleTranslationSaved = (field, bucket) => {
    setAdvances((prev) =>
      prev.map((a) =>
        a._id === translatingAdvance?._id
  ...
  return (
    <div className="pageShell">
              ...
              >
                ...
                <div className="dataTableActions">
                  ...
                  <button
                    ...
                    onClick={() => setTranslatingAdvance(advance)}
                  >
                    <Languages size={15} />
                  </button>
      ...
      <TranslationEditorModal
        isOpen={!!translatingAdvance}
        onClose={() => setTranslatingAdvance(null)}
        resourceType="advance"
        resourceId={translatingAdvance?._id}
        fields={[
          { key: "reason", label: t("advances.fields.reason") },
          { key: "reviewComment", label: t("advances.fields.reviewComment") },
        ]}
