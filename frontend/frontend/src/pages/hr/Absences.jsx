...
export default function Absences() {
  ...
  useEffect(() => {
    setPage(1);
  }, [selectedCompanyId, statusFilter, typeFilter, dateFrom, dateTo, debouncedSearch]);
  ...
  // ---------- Translations editor (reason, reviewComment) ----------
  const [translatingAbsence, setTranslatingAbsence] = useState(null);
  const handleTranslationSaved = (field, bucket) => {
    setAbsences((prev) =>
      prev.map((a) =>
        a._id === translatingAbsence?._id
          ? { ...a, translations: { ...a.translations, [field]: bucket } }
          : a
      )
    );
  };
  ...
  }, [selectedCompanyId, statusFilter, typeFilter, dateFrom, dateTo, debouncedSearch, page, t]);
  ...
  return (
    <div className="pageShell">
              ...
              >
                ...
                <div className="dataTableActions">
                  ...
                  <button
                    ...
                    onClick={() => setTranslatingAbsence(absence)}
                  >
                    <Languages size={15} />
                  </button>
      ...
      <TranslationEditorModal
        isOpen={!!translatingAbsence}
        onClose={() => setTranslatingAbsence(null)}
        resourceType="absence"
        resourceId={translatingAbsence?._id}
        fields={[
          { key: "reason", label: t("absences.fields.reason") },
          { key: "reviewComment", label: t("absences.fields.reviewComment") },
        ]}
