...
export const translations = {
  ...
  en: {
    ...
    purchaseRequests: {
      ...
      subtitle: "Requests to reorder inventory, pending the future purchasing module.",
    ...
    units: {
      ...
      component: "Component",
      part: "Part",
      assembly_unit: "Assembly unit",
      finished_unit: "Finished unit",
      ...
      linear_foot: "Linear foot (lf)",
      square_foot: "Square foot (ft²)",
      cubic_foot: "Cubic foot (ft³)",
      running_meter: "Running meter (rm)",
      running_foot: "Running foot (rf)",
      ...
      lbft: "Pound-foot (lb·ft)",

      // ======================================================
      // SPEED / FLOW
      // ======================================================
      m_per_s: "Meter per second (m/s)",
      m_per_min: "Meter per minute (m/min)",
      m_per_h: "Meter per hour (m/h)",
      km_per_h: "Kilometer per hour (km/h)",
      ft_per_min: "Foot per minute (ft/min)",
      l_per_min: "Liter per minute (L/min)",
      l_per_h: "Liter per hour (L/h)",
      m3_per_h: "Cubic meter per hour (m³/h)",
      ...
      mol: "Mole (mol)",
      mmol: "Millimole (mmol)",
      mol_per_l: "Mole per liter (mol/L)",
      g_per_l: "Gram per liter (g/L)",
      kg_per_m3: "Kilogram per cubic meter (kg/m³)",

      // ======================================================
      // DENSITY
      // ======================================================
      g_per_cm3: "Gram per cubic centimeter (g/cm³)",
      kg_per_m3: "Kilogram per cubic meter (kg/m³)",
      kg_per_l: "Kilogram per liter (kg/L)",
  ...
  fr: {
    ...
    purchaseRequests: {
      ...
      subtitle: "Demandes de réapprovisionnement, en attendant le futur module Achats.",
